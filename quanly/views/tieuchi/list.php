...
<!-- CONTENT -->
    <div class="main">
        <div class="main-content">
            <div class="path">
                <p><a href="?act=trangchu">Trang chủ</a><a href="?act=tieu_chi_list">Tiêu chí</a></p>
            </div>
            <div class="clear"></div>
					...
					<div class="main-header-button">
						...
						<div class="main-header-add">
                            ...
                            <div class="main-add-box">
                                <ul>
                                    <li><a href="?act=tieu_chi_list&active=1"><i class="fa fa-check"></i>Mở</a></li>
                                    <li><a href="?act=tieu_chi_list&active=0"><i class="fa fa-check"></i>Khoá</a></li>
                                </ul>
                            </div>
                        </div>
						<div class="main-header-add">
							<a href="?act=tieu_chi_add"><i class="fa fa-plus"></i>Thêm mới</a>
						</div>
                    </div>	
                </div>
                            ...
                            <tr class="first-row">
                                ...
                                <td style="min-width:50px !important;">
									<?php
										if(isset($_GET['order_id'])){
											if($order_id==1){
												echo '<a href="?act=tieu_chi_list&order_id=0" title="Giảm dần">ID</a>';
											}else{
												echo '<a href="?act=tieu_chi_list&order_id=1" title="Tăng dần">ID</a>';
											}
										}else{
											echo '<a href="?act=tieu_chi_list&order_id=0" title="Giảm dần">ID</a>';
										}
								...
								<td style="min-width:50px !important;">
									<?php
										if(isset($_GET['order_id'])){
											if($order_id==1){
												echo '<a href="?act=tieu_chi_list&order_tt=0" title="Giảm dần">TT</a>';
											}else{
												echo '<a href="?act=tieu_chi_list&order_tt=1" title="Tăng dần">TT</a>';
											}
										}else{
											echo '<a href="?act=tieu_chi_list&order_tt=0" title="Giảm dần">TT</a>';
										}
							...
							<?php
								...
								foreach($array as $row){
									...
									echo '<tr>';
										...
										echo '<td><ul>';
											echo '<li></li>';
											echo '<li><a href="?act=tieu_chi_edit&id='.$row['id'].'" title="Chỉnh sửa"><i class="fa fa-gear"></i></a></li>';
											...
											echo '<script>
															$(\'.delete-button-'.$row['id'].'\').on("click",function(){
																	$(\'<div class="delete-section"><p>Bạn có chắc chắn muốn xóa</p><div><a href="?act=tieu_chi_delete&id='.$row['id'].'"><i class="icon-checkmark"></i></a><button class="cancel-button"><i class="icon-cross"></i></button></div></div>\').appendTo(\'body\');
											...
											echo '<li></li>';
											if($row['active']==1){
												echo '<li><a href="?act=tieu_chi_active&id='.$row['id'].'&active=0" title="Bật / Tắt"><i class="icon-checkmark"></i></a></li>';
												echo '<li></li>';
											}else{
												echo '<li></li>';
												echo '<li><a href="?act=tieu_chi_active&id='.$row['id'].'&active=1" title="Tắt / Bật"><i class="icon-checkmark"></i></a></li>';
											}
										echo '</ul></td>';
									echo '</tr>';
								}
