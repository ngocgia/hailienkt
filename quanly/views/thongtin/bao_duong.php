	...
	<div class="main">
        <div class="main-content">
            <div class="path">
                <p><a href="?act=trangchu">Trang chủ</a><a href="?<?php echo $_SESSION['urlctkt'];?>">Bảo dưỡng</a></p>
            </div>
            <div class="clear"></div>
                            ...
                            <div class="add-info-left col-xs-12 col-sm-7">
								...
								<div class="one-add one-add-long-info">
									...
									<div class="one-wrap-form">
										<textarea rows="6" name="baoduong"><?php echo $baoduong['info'];?></textarea>
										<?php editorAreaFull('baoduong');?>
									</div>
								</div>
