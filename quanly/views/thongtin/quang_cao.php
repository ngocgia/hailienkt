	...
	<div class="main">
        <div class="main-content">
            <div class="path">
                <p><a href="?act=trangchu">Trang chủ</a><a href="?<?php echo $_SESSION['urlctkt'];?>">Banner quảng cáo</a></p>
            </div>
            <div class="clear"></div>
            <div class="add-header">
                <div class="add-header-name">
                    <h2>Banner quảng cáo dưới page</h2>
                </div>
            </div>
            <div class="add-table">
                            ...
                            <div class="add-info-left col-xs-12 col-sm-7">
								...
								<div class="one-add one-add-long-info">
									...
									<div class="one-wrap-form">
										<textarea rows="6" name="ads"><?php echo $ads['info'];?></textarea>
									</div>
								</div>
