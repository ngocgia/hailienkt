        ...
        <div class="main-content">
            <div class="path">
                <p>
					...
					<a href="?act=nhap_hang_list">Thống kê nhập hàng</a>
					<a href="?act=nhap_hang_ghi_no">Ghi nợ</a>
				</p>
            </div>
            <div class="search">
                ...
                <div class="main-header">
                    ...
                    <div class="main-header-button">
						...
						<div class="main-header-export">
                            <a class="main-button-export" href="exel/ghinocantra.xlsx"><i class="fa fa-sign-out"></i>Download</a>
                        </div>
                    </div>					
                </div>
                    ...
                    <div class="inner-main-table">
                        <table>							
                            <tr class="first-row">
                                ...
                                <td>ID</td>								
								<td style="min-width:100px !important;">Đối tác</td>
							...
							<?php			
								foreach($array as $row){
									echo '<tr>';
										...
										echo '<td>'.$row['id'].'</td>';
										$row_dt = $db->get_row_doi_tac($row['id_dt']);
										echo '<td style="min-width:100px !important;"><a href="?act=doi_tac_detail&id='.$row_dt['id'].'" tilte="click để xem chi tiết!">'.$row_dt['name'].'</a></td>';
										...
										echo '<td><ul>';
											echo '<li><a href="?act=nhap_hang_detail&id='.$row['id'].'" title="Chi tiết"><i class="icon-pencil"></i></a></li>';
											echo '<li><a href="?act=nhap_hang_edit&id='.$row['id'].'" title="Chỉnh sửa ghi nợ"><i class="fa fa-gear"></i></a></li>';
											...
											echo '<script>
															$(\'.delete-button-'.$row['id'].'\').on("click",function(){
																	$(\'<div class="delete-section"><p>Bạn có chắc chắn muốn xóa</p><div><a href="?act=nhap_hang_delete&id='.$row['id'].'"><i class="icon-checkmark"></i></a><button class="cancel-button"><i class="icon-cross"></i></button></div></div>\').appendTo(\'body\');
											...
											echo '<li></li>';
											echo '<li></li>';
											echo '<li><a href="?act=nhap_hang_active&id='.$row['id'].'&active=1" title="Click để xóa nợ!"><i class="icon-checkmark"></i></a></li>';
										echo '</ul></td>';
									echo '</tr>';
								}								
							?>
